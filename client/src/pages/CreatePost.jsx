...
function CreatePost(props) {
    ...
    const generateImage = async (e) => {
        if (form.prompt) {
            try {
                ...
                const response = await fetch('https://dall-e-e6pf.onrender.com/api/v1/dalle', {
                    method: 'POST',
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.prompt && form.photo) {
            ...
            try {
                const response = await fetch('https://dall-e-e6pf.onrender.com/api/v1/post', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
        ...
        <section className="max-w-7xl mx-auto">
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
                    Create imaginative and visually stunning images generated by DALL-e AI and share them with the
                    community
                </p>
            </div>
            ...
            <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
                ...
                <div className="mt-10">
                    <p>Once you have crated the image you want, you can share it with others in the community</p>
                    <button type="submit"
